...
- **File:** [src/LS.h]([src/LS.h#L1](https://github.com/Fi0nee/LS-Buttplug/PlatformIO/src/LS.h) — the discovered values belong in the `manufacturerDataList` array used by the main project.
...
3. When you find working codes, copy the corresponding bytes into the `manufacturerDataList` array in [src/LS.h]([src/LS.h#L1](https://github.com/Fi0nee/LS-Buttplug/PlatformIO/src/LS.h)) of the main project (https://github.com/Fi0nee/LS-Buttplug).
